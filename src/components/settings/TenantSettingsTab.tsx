...
const TenantSettingsTab: React.FC = () => {
  ...
  // トパーズ社の管理者以外はアクセス不可
  // tenant_idが'topaz-sms'かつroleが'admin'のユーザーのみアクセス可能
  if (!tenant || !user || user.role !== 'admin' || user.tenant_id !== 'topaz-sms') {
    return (
      <div className="text-center py-10">
        ...
        <p className="mt-2 text-sm text-grey-500">トパーズ社の管理者にお問い合わせください</p>
      </div>
    );
  }

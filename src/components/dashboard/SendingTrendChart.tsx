...
import { ArrowUpRight, Clock, Calendar, BarChart2, TrendingUp, ChevronLeft, ChevronRight, Calendar as CalendarIcon } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <motion.div 
          className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 rounded-lg text-white shadow-md"
          whileHover={{ scale: 1.03 }}
          transition={{ duration: 0.2 }}
        >
          <div className="flex justify-between items-start">
            <div>
              <p className="text-blue-100 text-sm font-medium">総送信数</p>
              <h4 className="text-2xl font-bold mt-1">{selectedTab === 'trend' ? totalSent.toLocaleString() : hourlyTotalSent.toLocaleString()}</h4>
            </div>
          ...
          <div className="mt-3">
            <span className="text-xs bg-white bg-opacity-20 px-2 py-1 rounded-full text-blue-50">
